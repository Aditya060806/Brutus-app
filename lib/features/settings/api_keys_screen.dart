...
enum _KeyKind { gemini, groq, tavily, huggingface, sarvam }
...
class _ApiKeysScreenState extends ConsumerState<ApiKeysScreen> {
  final _defs = const [
    ...
    _ApiKeyDef(
      kind: _KeyKind.sarvam,
      name: 'Sarvam API Key',
      description: 'Indic voice + LLM (STT · TTS · chat)',
  ...
  Future<void> _refreshStatus() async {
    ...
    setState(() {
      _isSet = {
        ...
        _KeyKind.sarvam: status['sarvam'] ?? false,
      };
      _loading = false;
    });
  }
  ...
  Future<void> _save(_KeyKind kind, String value) async {
    ...
    switch (kind) {
      ...
      case _KeyKind.huggingface:
        ...
        break;
      case _KeyKind.sarvam:
        await SecureStorageService.setSarvamKey(trimmed);
        break;
    }
