...
class ApiConstants {
  ...
  // ── Sarvam (Indic STT · TTS · LLM) ──
  static const sarvamBaseUrl = 'https://api.sarvam.ai';
  static const sarvamChatCompletions = '$sarvamBaseUrl/v1/chat/completions';
  static const sarvamTtsUrl = '$sarvamBaseUrl/text-to-speech';
  static const sarvamSttUrl = '$sarvamBaseUrl/speech-to-text';
  static const sarvamDefaultChatModel = 'sarvam-30b'; // or sarvam-105b
  static const sarvamTtsModel = 'bulbul:v2';
  static const sarvamTtsSampleRate = 22050; // resampled to 24k in-app for playback
  ...
  static const sarvamApiKey = 'sarvam_api_key';
