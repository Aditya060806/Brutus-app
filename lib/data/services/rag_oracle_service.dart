...
class RagOracleService {
  ...
  /// Route synthesis through the user-selected text-LLM engine.
...
''';
  ...
  Stream<OracleEvent> ask(
    ...
    // Pre-check keys for friendly errors. Embeddings always run on Gemini,
    // regardless of which engine synthesizes the answer.
