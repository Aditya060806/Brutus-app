...
class EmbeddingsClient {
  ...
  Future<List<double>> embed(
    ...
    final url =
        '${ApiConstants.geminiRestBase}/models/${ApiConstants.geminiEmbedModel}:embedContent?key=$apiKey';
  ...
  Future<List<List<double>>> embedBatch(
    ...
    final url =
        '${ApiConstants.geminiRestBase}/models/${ApiConstants.geminiEmbedModel}:batchEmbedContents?key=$apiKey';
